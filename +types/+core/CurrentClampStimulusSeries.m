...
methods
    function obj = CurrentClampStimulusSeries(varargin)
        ...
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1, 'float32') 'data_resolution' types.util.correctType(-1, 'float32') 'data_unit' 'amperes' 'description' 'no description'} varargin];
