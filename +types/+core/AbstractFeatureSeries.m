...
methods
    function obj = AbstractFeatureSeries(varargin)
        ...
        % features = char
        % feature_units = char
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1, 'float32') 'data_resolution' types.util.correctType(-1, 'float32') 'data_unit' 'see `feature_units`' 'description' 'no description'} varargin];
