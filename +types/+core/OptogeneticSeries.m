...
methods
    function obj = OptogeneticSeries(varargin)
        ...
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1, 'float32') 'data_resolution' types.util.correctType(-1, 'float32') 'data_unit' 'watts' 'description' 'no description'} varargin];
